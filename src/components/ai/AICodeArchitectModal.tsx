...
export const AICodeArchitectModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/70 backdrop-blur-md flex items-center justify-center p-4 select-none">
      <div className="bg-slate-900 border border-slate-700 text-white rounded-2xl max-w-3xl w-full shadow-2xl overflow-hidden flex flex-col max-h-[90vh] animate-in fade-in zoom-in-95">
        {/* Modal Header */}
        <div className="p-4 bg-slate-950 border-b border-slate-800 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-extrabold text-sm text-white tracking-tight uppercase font-mono">
                AI CODE ARCHITECT & DEBUGGER AGENT
              </h3>
              <p className="text-[10px] text-cyan-300 font-mono font-medium">
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1 text-xs">
          ...
          <div className="p-4 rounded-xl bg-slate-800/60 border border-slate-700/80 space-y-3">
            ...
            <div className="space-y-1.5 pt-1">
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="flex-1 bg-slate-900 border border-slate-700 rounded-xl px-3 py-2 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-cyan-400 font-mono"
                />
                <button
            ...
            <div className="space-y-1 pt-1">
              <span className="text-[10px] text-slate-400 font-mono">Quick Template Presets:</span>
              <div className="flex flex-wrap gap-1.5">
                {codeTemplates.map((tmpl, idx) => (
                  <button
                    ...
                    className="px-2.5 py-1 rounded-lg bg-slate-900 hover:bg-slate-700 border border-slate-700 text-[11px] text-cyan-300 font-mono transition-all"
                  >
                    {tmpl.label}
                  </button>
                ))}
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-slate-800 hover:bg-slate-700 border border-slate-700 text-[11px] text-slate-300 transition-all flex items-center space-x-1"
                >
            ...
            <pre className="p-4 rounded-xl bg-black border border-slate-800 text-cyan-300 font-mono text-xs overflow-x-auto max-h-52 leading-relaxed shadow-inner">
